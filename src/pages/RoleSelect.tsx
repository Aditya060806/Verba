  ...
  const roles = [
    {
      ...
      side: "Government",
      order: 1,
      description: "Opens the debate for the Government side. Sets the framework and presents the first arguments.",
      strategy: "Focus on defining the motion clearly, establishing your framework, and presenting 2-3 strong arguments with clear reasoning.",
      color: "primary"
    },
    {
      value: "lo",
      ...
      side: "Opposition",
      order: 2,
      description: "Opens the debate for the Opposition side. Challenges the Government's case and presents counter-arguments.",
      strategy: "Challenge the Government's definition if necessary, rebut their arguments systematically, and present your own case.",
      color: "accent"
    },
    {
      value: "dpm",
      ...
      side: "Government",
      order: 3,
      description: "Strengthens the Government case and responds to Opposition challenges.",
      strategy: "Rebuild and strengthen your team's arguments, respond to Opposition rebuttals, and introduce new material if needed.",
      color: "primary"
    },
    {
      value: "dlo",
      ...
      side: "Opposition",
      order: 4,
      description: "Reinforces Opposition case and challenges Government rebuttals.",
      strategy: "Strengthen Opposition arguments, respond to Government rebuilds, and continue systematic rebuttal.",
      color: "accent"
    },
    {
      value: "gw",
      ...
      side: "Government",
      order: 5,
      description: "Summarizes and crystallizes the debate for the Government.",
      strategy: "No new arguments! Focus on comparing cases, identifying key clashes, and explaining why Government wins.",
      color: "primary"
    },
    {
      value: "ow",
      ...
      side: "Opposition",
      order: 6,
      description: "Delivers the final speech for the Opposition.",
      strategy: "No new arguments! Compare cases, highlight Opposition's strongest points, and explain why Opposition wins the debate.",
      color: "accent"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-xl text-foreground-secondary max-w-2xl mx-auto">
            Choose your role and skill level to begin your debate round
          </p>
        </div>
